...
from typing import Iterable, Iterator, Optional, Set, Union, Sequence
...
class AsyncEmbeddingEngine:
    ...
    async def image_embed(
        self, *, images: Sequence[Union[str, "ImageClass"]]
    ) -> tuple[list[EmbeddingReturnType], int]:
        """embed multiple images

        Kwargs:
            images (list[Union[str, ImageClass]]): list of image urls or ImageClass objects, to be embedded
...
class AsyncEngineArray:
    ...
    async def image_embed(
        self, *, model: str, images: Sequence[Union[str, "ImageClass"]]
    ) -> tuple[list[EmbeddingReturnType], int]:
        """embed multiple images
