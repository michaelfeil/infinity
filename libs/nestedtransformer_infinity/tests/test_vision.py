...
class NestedTransformersVisionTest(NestedTransformersTestMixin, unittest.TestCase):
    r"""
    Testing suite for Vision Models - tests all the tests defined in `NestedTransformersTestMixin`
    """
    ...
    def prepare_inputs_for_class(
        self, model_id, model_type, batch_size=3, **preprocessor_kwargs
    ):
        if model_type == "vilt":
