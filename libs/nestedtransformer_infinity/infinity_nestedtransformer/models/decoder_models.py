...
class GPT2AttentionLayerNestedTransformer(NestedTransformerBaseLayer, GPT2Attention):
    ...
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        ...
        with torch.device("meta"):
            super(NestedTransformerBaseLayer, self).__init__(
                config, layer.is_cross_attention, layer.layer_idx
            )
...
class GPTJAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, GPTJAttention, nn.Module
):
    ...
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
        with torch.device("meta"):
            super(NestedTransformerBaseLayer, self).__init__(config)
...
class GPTNeoXAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, GPTNeoXAttention, nn.Module
):
    _attn = gpt2_wrapped_scaled_dot_product
...
class GPTNeoAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, GPTNeoSelfAttention, nn.Module
):
    ...
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        ...
        self.scale = torch.sqrt(torch.tensor(layer.head_dim, dtype=torch.float32)).to(
...
class BarkAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, BarkSelfAttention, nn.Module
):
    _attn = bark_wrapped_scaled_dot_product

    def __init__(
        self, layer: "nn.Module", config: "PretrainedConfig", is_causal: bool = False
    ):
        super().__init__(config)
        ...
        with torch.device("meta"):
            super(NestedTransformerBaseLayer, self).__init__(config, is_causal)
...
class BloomAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, BloomAttention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
...
class CodegenAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, CodeGenAttention, nn.Module
):
...
class OPTAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, OPTAttention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
...
class T5AttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, T5Attention, torch.nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        ...
        with torch.device("meta"):
            super(NestedTransformerBaseLayer, self).__init__(
                config, layer.has_relative_attention_bias
            )
        ...
        self.scale = torch.sqrt(torch.tensor(head_dim, dtype=torch.float32)).to(
            torch.get_default_dtype()
        )
...
class BartAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, BartAttention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
...
class BlenderbotAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, BlenderbotAttention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
        bart_bettertransformer_init(self, layer, config)
...
class M2M100AttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, M2M100Attention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
        bart_bettertransformer_init(self, layer, config)
...
class MarianAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, MarianAttention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        super().__init__(config)
        bart_bettertransformer_init(self, layer, config)
...
class PegasusAttentionLayerNestedTransformer(
    NestedTransformerBaseLayer, PegasusAttention, nn.Module
):
    def __init__(self, layer: "nn.Module", config: "PretrainedConfig"):
        bart_bettertransformer_init(self, layer, config)
