...
from infinity_nestedtransformer.utils.preprocessing.image_classification import (
    ImageClassificationProcessing,
)
from infinity_nestedtransformer.utils.preprocessing.question_answering import (
    QuestionAnsweringProcessing,
)
from infinity_nestedtransformer.utils.preprocessing.text_classification import (
    TextClassificationProcessing,
)
from infinity_nestedtransformer.utils.preprocessing.token_classification import (
...
class TaskProcessorsManager:
    ...
    @classmethod
    def for_task(
        cls, task: str, *dataset_processing_args, **dataset_processing_kwargs: Any
    ) -> "TaskProcessor":
        return cls.get_task_processor_class_for_task(task)(
            *dataset_processing_args, **dataset_processing_kwargs
        )
